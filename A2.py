...
def Tack_Object(yolo_model, deep_sort_model, source, output, imgsz, conf_thres, iou_thres, fourcc,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='videos/Traffic.mp4', help='source')  # file/folder, 0 for webcam // videos/Traffic.mp4
    ...
    # print("11",opt)
    # a = Tack_Object(yolo_model='yolov5s.pt', deep_sort_model='osnet_x0_25', source='0',
    #                 output='inference/output', imgsz=[480, 480], conf_thres=0.5, iou_thres=0.5, fourcc='mp4v', device='',
    #                 show_vid=True, save_vid=False, save_txt=False, classes=2, agnostic_nms=False, augment=False, evaluate=False,
    #                 config_deepsort='deep_sort/configs/deep_sort.yaml', half=False, visualize=False, max_det=1000, dnn=False,
    #                 project="WindowsPath('runs/track')", name='exp', exist_ok=False)
    # a.detect(yolo_model='yolov5s.pt', deep_sort_model='osnet_x0_25', source='0',
    #          output='inference/output', imgsz=[480, 480], conf_thres=0.5, iou_thres=0.5, fourcc='mp4v', device='',
    #          show_vid=True, save_vid=False, save_txt=False, classes=2, agnostic_nms=False, augment=False, evaluate=False,
    #          config_deepsort='deep_sort/configs/deep_sort.yaml', half=False, visualize=False, max_det=1000, dnn=False,
    #          project="WindowsPath('runs/track')", name='exp', exist_ok=False)
    ...
    # with torch.no_grad():
    #     print("ds",torch.no_grad())
    #     # Tack_Object.detect(opt)
    # Tack_Object(out='inference/output',
    #             source='videos/Car.jpg',
    #             yolo_model='yolov5s.pt',
    #             deep_sort_model='osnet_x0_25',
    #             show_vid=True, save_vid=False,
    #             save_txt=False, imgsz=[480, 480],
    #             evaluate=False, half=False,
    #             project="WindowsPath('runs/track')",
    #             name='exp',
    #             exist_ok=False).\
    #     detect(out='inference/output',
    #             source='videos/Car.jpg',
    #             yolo_model='yolov5s.pt',
    #             deep_sort_model='osnet_x0_25',
    #             show_vid=True, save_vid=False,
