...
class MainWindow(QMainWindow, Ui_MainWindow): #comment: Mở Ui_MainWindow
    def __init__(self, parent=None):
        ...
        # Add "Connect to Camera" button to tab #Comment: tạo Table conect camera...
    ...
    def connectToCamera(self):
        ...
        # Attempt to connect to camera
            ...
            # Get next tab index
            nextTabIndex = 0 if len(self.deviceUrlDict) == 0 else self.tabWidget.count() #Comment: Set thứ tự table

            # Show dialog
            cameraConnectDialog = CameraConnectDialog(self, self.actionSynchronizeStreams.isChecked()) #Comment: Mở hộp tab
            if cameraConnectDialog.exec() == QDialog.Accepted: #Comment: if = 1
                # Save user-defined device deviceUrl
                deviceUrl = cameraConnectDialog.getDeviceUrl()  #Comment: Cài đặt đầu vào video
